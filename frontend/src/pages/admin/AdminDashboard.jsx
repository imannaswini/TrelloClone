    ...
    >
      ...
      >
        ...
        {[
          ...
          >
            ...
            <p className="text-5xl font-extrabold mt-3 bg-gradient-to-r
      ...
      >
        ...
        <ul className="mt-4 text-gray-300 space-y-2 text-sm">
          <motion.li whileHover={{ x: 6 }}>• Manager created a new board</motion.li>
          <motion.li whileHover={{ x: 6 }}>• Admin approved 2 members</motion.li>
          <motion.li whileHover={{ x: 6 }}>• Project “SPARK System” updated</motion.li>
        </ul>
      </motion.div>
    </motion.div>
  );
